...
public class CalendarEx1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("무슨 요일 : " 
				+ today.get(Calendar.DAY_OF_WEEK)); //일요일부터 시작
		System.out.println("이 달의 몇 째 요일 : " 
				+ today.get(Calendar.DAY_OF_WEEK_IN_MONTH)); //일요일부터 시작
		System.out.println("오전 오후 : " 
				+ today.get(Calendar.AM_PM));
		System.out.println("12시간 체계의 시간 : " 
				+ today.get(Calendar.HOUR));
		System.out.println("24시간 체계의 시간 : " 
				+ today.get(Calendar.HOUR_OF_DAY));
		System.out.println("분 : " 
				+ today.get(Calendar.MINUTE));
		System.out.println("초 : " 
				+ today.get(Calendar.SECOND));
		System.out.println("초/1000 : " 
